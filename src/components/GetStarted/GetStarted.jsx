        ...
        <div className='bg-base-200'>
            <div className='max-w-7xl mx-auto p-20'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3'>
                    <div className="card w-75 bg-base-100 card-xs shadow-sm text-center py-10 relative">
                    ...
                    <div className="card w-75 bg-base-100 card-xs shadow-sm py-10 text-center relative">
