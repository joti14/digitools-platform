...
const ReadyToTransform = () => {
    return (
        <div className='bg-linear-to-r from-[rgba(79,57,246,1)] to-[rgba(149,20,250,1)] px-6 py-12 md:p-20 text-center text-white space-y-8'>
            <div className='space-y-3'>
                <h1 className='text-2xl md:text-4xl font-bold'>Ready to Transform Your Workflow?</h1>
                <p>Join thousands of professionals who are already using Digitools to work smarter. <br className='hidden md:block' /> Start your free trial today.</p>
            </div>
            ...
            <p className='text-sm md:text-base'>14-day free trial • No credit card required • Cancel anytime</p>
        </div>
    );
};
